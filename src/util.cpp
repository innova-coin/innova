...
void WriteConfigFile(FILE* configFile)
{
    ...
    fputs ("server=1\n", configFile);
    fputs ("addnode=209.250.240.159:14520\n", configFile);
    fputs ("addnode=195.154.150.149:14520\n", configFile);
    fputs ("addnode=62.210.251.30:14520\n", configFile);
    fputs ("addnode=66.206.29.179:14520\n", configFile);
    fputs ("addnode=62.210.245.190:14520\n", configFile);
    fclose(configFile);
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
  ...
  // Create empty innova.conf if it does not excist
       ...
       if (configFile != NULL) {
        ...
        LogPrintf("innova.conf file could not be found or can't be created");
